...
namespace Middleware_Run
{
    ...
    public int current_robot_index  // between 1-32
    {
        set
        {
            ...
            {
                current_robot_index_ = 0;   //meaning to robot null
            }
    ...
    public async Task<int> init_middleware_async()
    {
    ...
    public async Task<int> init_active_core_async()
    {
        var taskResult = await Task.Factory.StartNew(() =>
        {
            int result = 0;
    ...
    public async Task<int> get_program_list_async()
    {
        var taskResult = await Task.Factory.StartNew(() =>
        {
            int result = 0;
    ...
    public async Task<int> Start_async(string program_name)
    {
        var taskResult = await Task.Factory.StartNew(() =>
        {
            int result = 0;
    ...
    public async Task<int> Servo_on_async()
    {
        var taskResult = await Task.Factory.StartNew(() =>
        {
            int result = 0;
    ...
    public async Task<int> Servo_off_async()
    {
        var taskResult = await Task.Factory.StartNew(() =>
        {
            int result = 0;
    ...
    public async Task<int> Reset_async()
    {
        var taskResult = await Task.Factory.StartNew(() =>
        {
            int result = 0;
    ...
    public async Task<int> Reset_program_async()
    {
        var taskResult = await Task.Factory.StartNew(() =>
        {
            int result = 0;
    ...
    public async Task<int> Request_cancel_async()
    {
        var taskResult = await Task.Factory.StartNew(() =>
        {
            int result = 0;
